...
st.set_page_config(
    page_title="AI-BASED CYBERSECURITY NETWORK THREAT & INTRUSION PROFILER",
    page_icon="🛡️",
    layout="wide",
...
with tab4:
    ...
    st.write(
        """
        To develop an AI-based network intrusion detection system
        that analyzes network traffic and identifies potential
        cyber attacks using a Random Forest machine learning model.
        """
    )
    ...
    st.write(
        ...
        Detecting malicious network activity manually can be difficult
        and time-consuming.

        This project uses Artificial Intelligence and Machine Learning
        to analyze network traffic patterns and identify potential
    ...
    st.write(
        """
        The project uses the NSL-KDD network intrusion detection
        dataset. It contains network traffic features representing
        normal traffic and different types of cyber attacks.
        """
    )
    ...
    st.markdown(
        ...
        **Step 1 — Dataset Collection**
        ...
        The system uses the NSL-KDD dataset containing network
        traffic records.
        ...
        **Step 2 — Data Preprocessing**
        ...
        Network traffic data is prepared for machine learning.

        **↓**

        **Step 3 — Feature Encoding**

        Categorical features such as protocol type, service and
        flag are converted into numerical values.

        **↓**

        **Step 4 — Model Training**

        A Random Forest classifier is trained using the processed
        network traffic data.

        **↓**

        **Step 5 — Network Traffic Prediction**

        The trained model analyzes a selected network traffic record.

        **↓**

        **Step 6 — Threat Classification**

        The system identifies whether the traffic is normal or
        represents a potential network attack.

        **↓**

        **Step 7 — Dashboard Visualization**

        The prediction and threat level are displayed through
        the Streamlit cybersecurity dashboard.
        """
    )
    ...
    st.write(
        ...
        that combines multiple decision trees to perform
        classification.
        """
    )
    ...
    st.markdown(
        ...
        - 🛡️ **NSL-KDD** — Network intrusion detection dataset
        """
    )
    ...
    st.subheader("⚠️ Project Limitation")

    st.write(
        """
        The system is trained using the NSL-KDD dataset.
        Therefore, performance on completely new or previously
        unseen real-world attack patterns may differ.
        """
    )
    ...
    st.markdown(
        ...
        - Detection of new attack patterns
